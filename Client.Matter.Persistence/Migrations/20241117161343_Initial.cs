        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MatterCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    MatterDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressId = table.Column<int>(type: "int", nullable: false),
                    MatterCount = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_People_PeopleId_ClientId",
                table: "People",
                columns: new[] { "PeopleId", "ClientId" },
                unique: true);
        }
